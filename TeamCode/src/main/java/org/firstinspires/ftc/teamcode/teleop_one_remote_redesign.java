...
public class teleop_one_remote_redesign extends LinearOpMode {
    ...
    //motors
    DcMotor mtrBL , mtrBR , mtrFL , mtrFR , mtrLift1, mtrLift2;
    Servo extend , grab , hooks, LED_strip;
    TouchSensor bottomLimit;
    DistanceSensor distance_left, distance_right;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            //LIFT
                //bottom limit switch
                if(gamepad1.left_stick_y>0 && bottomLimit.isPressed()){
                    ...
                    mtrLift1.setPower(gamepad1.left_stick_y);
                    mtrLift2.setPower(gamepad1.left_stick_y);
                }
            }
