...
public class TuningController {
    public static double MOTOR_TICKS_PER_REV = 103.6;
    public static double MOTOR_MAX_RPM = 1780;
    public static double MOTOR_GEAR_RATIO = 3.7; // output (wheel) speed / input (motor) speed
