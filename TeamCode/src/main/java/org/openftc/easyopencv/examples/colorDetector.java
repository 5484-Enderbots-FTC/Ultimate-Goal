...
current status not done, only tracks for skystone color, not detects all color, note lines 46-55 the current issue is that it only tracks for a specific color, find out how to NOT
